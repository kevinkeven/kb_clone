        ...
        <bem.FormModal__item m='wrapper'>
          ...
          <bem.FormModal__item m='metadata-share'>
            <Checkbox
              ...
              label={t('Share the sector and country where this project will be deployed to assist DigikYar in improving this product.') + ' ' + t('All information is supplied anonymously, and the project name and description are not included.')}
            />
          </bem.FormModal__item>
