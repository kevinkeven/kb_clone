...
test = t('This question could not be imported. Please re-create it manually. Please contact us at help@digikyar.org so we can fix this bug!');
test = t('Add Question');
test = t('or');
test = t('Import XLS');
...
test= t('The server encountered an error while trying to deploy the project. If this problem persists, please contact <a href="mailto:help@digikyar.org">help@digikyar.org</a>.');
